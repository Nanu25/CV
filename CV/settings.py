...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-dev-only-fallback-key')
...
# Production security settings (only active on Heroku where DEBUG is False)
if not DEBUG:
